...
class ReviewAgent:
    ...
    def __init__(self, persona: PersonaConfig, model_provider: Optional[str] = None, model_config_override: Optional[Dict[str, Any]] = None):
...
Be professional but thorough in your analysis."""
    ...
    def _create_ollama_model(self, config: Dict[str, Any]):
        ...
        try:
            ...
            print("⚠️  Ollama model not available. Install Ollama or use a different provider.")
            return None
