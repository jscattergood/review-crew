...
"""
        ...
        multi_personas = loader.load_reviewer_personas_by_category(["academic", "content"])
...
"""
        ...
        multi_personas = loader.load_reviewer_personas_by_names(["Content Reviewer", "Technical Reviewer"])
        assert len(multi_personas) == 2
        names = [p.name for p in multi_personas]
        assert "Content Reviewer" in names
        assert "Technical Reviewer" in names
