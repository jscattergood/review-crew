...
class TestBaseAgent:
    ...
    def agent_with_reasoning_model(self, mock_persona_with_model_id):
        ...
        agent = BaseAgent(persona=mock_persona_with_model_id, model_provider="lm_studio")
    ...
    def agent_with_standard_model(self, mock_persona_standard_model):
        ...
        agent = BaseAgent(persona=mock_persona_standard_model, model_provider="lm_studio")
    ...
    def agent_without_model_id(self, mock_persona_without_model_id):
        ...
        agent = BaseAgent(persona=mock_persona_without_model_id, model_provider="lm_studio")
    ...
    def test_get_max_context_length_with_explicit_config(self, agent_with_reasoning_model):
    ...
    def test_get_max_context_length_reasoning_model_detection(self, mock_persona_without_model_id):
    ...
    def test_get_max_context_length_standard_model_detection(self, mock_persona_without_model_id):
    ...
    def test_get_max_context_length_claude_model(self, mock_persona_without_model_id):
        ...
        agent = BaseAgent(persona=mock_persona_without_model_id, model_provider="bedrock")
        context_length = agent.get_max_context_length()
    ...
    def test_count_tokens_without_tiktoken(self, agent_with_reasoning_model):
        ...
        with patch('builtins.__import__', side_effect=mock_import):
            token_count = agent_with_reasoning_model._count_tokens("test text with 20 chars")
    ...
    def test_truncate_prompt_with_tiktoken(self, agent_with_reasoning_model):
        ...
        with patch('tiktoken.get_encoding') as mock_get_encoding:
            ...
            truncated = agent_with_reasoning_model._truncate_prompt("long text", max_tokens=5)
            
            assert "truncated text" in truncated
            assert "[... content truncated due to context length limit ...]" in truncated
    ...
    def test_truncate_prompt_without_tiktoken(self, agent_with_reasoning_model):
        ...
        with patch('builtins.__import__', side_effect=mock_import):
            ...
            truncated = agent_with_reasoning_model._truncate_prompt(long_text, max_tokens=10)
    ...
    def test_truncate_prompt_no_truncation_needed(self, agent_with_reasoning_model):
        ...
        with patch('builtins.__import__', side_effect=mock_import):
            short_text = "short"
            result = agent_with_reasoning_model._truncate_prompt(short_text, max_tokens=10)
    ...
    def test_should_chunk_content_true(self, agent_with_standard_model):
        ...
        with patch('builtins.__import__', side_effect=mock_import):
            ...
            large_content = "a" * 30000  # 30,000 characters, definitely exceeds available tokens
    ...
    def test_get_model_config_ollama_provider(self, mock_persona_without_model_id):
        ...
        agent = BaseAgent(persona=mock_persona_without_model_id, model_provider="ollama")
        config = agent._get_model_config()
