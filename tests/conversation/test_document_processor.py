...
class TestDocumentProcessorManifestValidation:
    ...
    def test_validate_manifest_schema_with_valid_manifest(self, processor, valid_manifest, schema, capsys):
    ...
    def test_validate_manifest_schema_with_invalid_manifest(self, processor, invalid_manifest, schema, capsys):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            captured = capsys.readouterr()
            assert "❌ Manifest schema validation failed for manifest.yaml:" in captured.out

    def test_validate_manifest_schema_no_schema_file(self, processor, valid_manifest, capsys):
    ...
    def test_validate_manifest_schema_no_jsonschema_module(self, processor, valid_manifest, capsys):
    ...
    def test_validate_manifest_schema_json_error(self, processor, valid_manifest, capsys):
    ...
    def test_load_manifest_with_schema_validation(self, processor, valid_manifest, schema):
...
class TestDocumentProcessorIntegration:
    ...
    def test_real_manifest_validation(self, processor):
        ...
        manifest_path = Path("/Users/scattej/Documents/GitHub/personal/review-crew/input/essay_comparison/manifest.yaml")
    ...
    def test_schema_path_resolution(self, processor):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            manifest = {"review_configuration": {"name": "test", "description": "test", "version": "1.0"}}
