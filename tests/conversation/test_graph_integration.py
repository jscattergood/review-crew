...
class TestGraphIntegration:
    ...
    @patch("src.agents.base_agent.Agent")
    @pytest.mark.asyncio
    async def test_review_agent_as_graph_node_async(
        self, mock_agent_class, mock_persona
    ):
    ...
    def test_content_extraction_from_dict(self, mock_agent_class, mock_persona):
        ...
        task_dict = {"content": "Test content from dict", "metadata": "Some metadata"}
    ...
    @patch("src.agents.base_agent.Agent")
    @pytest.mark.asyncio
    async def test_backward_compatibility_methods_still_work(
        self, mock_agent_class, mock_persona
    ):
